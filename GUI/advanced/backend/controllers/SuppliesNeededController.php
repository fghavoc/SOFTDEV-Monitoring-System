...
class SuppliesNeededController extends Controller
{
     ...
     * @return mixed
     */
    public function actionView($id, $suggested_supplies_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($id, $suggested_supplies_id),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id, 'suggested_supplies_id' => $model->suggested_supplies_id]);
        } else {
     ...
     * @return mixed
     */
    public function actionUpdate($id, $suggested_supplies_id)
    {
        $model = $this->findModel($id, $suggested_supplies_id);
     ...
     * @return mixed
     */
    public function actionDelete($id, $suggested_supplies_id)
    {
        $this->findModel($id, $suggested_supplies_id)->delete();
     ...
     */
    protected function findModel($id, $suggested_supplies_id)
    {
        if (($model = SuppliesNeeded::findOne(['id' => $id, 'suggested_supplies_id' => $suggested_supplies_id])) !== null) {
            return $model;
        } else {
