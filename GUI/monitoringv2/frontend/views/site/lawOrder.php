  ...
  <div style="margin: 15px 0px 0px; display: inline-block; text-align: center; width: 288px;"><div style="display: inline-block; padding: 2px 4px; margin: 0px 0px 5px; border: 1px solid rgb(204, 204, 204); text-align: center; background-color: rgb(255, 255, 255);"><a href="http://localtimes.info/Asia/Philippines/Manila/" style="text-decoration: none; font-size: 13px; color: rgb(0, 0, 0);"><img src="http://localtimes.info/images/countries/ph.png"="" border=0="" style="border:0;margin:0;padding:0"=""> Manila</a></div><script type="text/javascript" src="http://localtimes.info/clock.php?continent=Asia&country=Philippines&city=Manila&cp1_Hex=000000&cp2_Hex=FFFFFF&cp3_Hex=000000&fwdt=288&ham=0&hbg=0&hfg=0&sid=0&mon=0&wek=0&wkf=0&sep=0&widget_number=1014"></script></div>
    ...
    <div class="box">
      <div class="box-header with-border">
       ...
       <iframe width="1030" height="600" src="https://app.powerbi.com/view?r=eyJrIjoiYWFiNjg5NTctOTYzNi00Y2M4LWEzNzItYmI4NzU3ZGM5OWI4IiwidCI6ImFlYjc0NWU2LTgxNjYtNGY4Zi05MjMzLTE3OWU4MTA5YzQ5ZSIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>
          </div>
    </div>
